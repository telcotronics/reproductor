...
public class ControlWeb {
    ...
    String web = "<!DOCTYPE html>\n"
            ...
            + "    <div id=\"\" class=\"bt_flotantePlay\" onclick=\"play()\"><i class=\"material-icons left btn_dysplay\">play_arrow</i></div>\n"
            ...
            + "            <button class=\"btn_rep btn\" onclick=\"mp3()\">\n"
            + "              <i class=\"material-icons left\">music_video</i>Audio\n"
            + "            </button>\n"
            + "          </div>\n"
            + "          <div class=\"col l4 m4 s12\">\n"
            + "            <button class=\"btn_rep btn\" onclick=\"youtube()\">\n"
            + "              <i class=\"material-icons left\">live_tv</i> Video\n"
            + "            </button>\n"
            + "          </div>\n"
            + "          <div class=\"col l4 m4 s12\">\n"
            + "            <button class=\"btn_rep btn\" onclick=\"cloud()\">\n"
            + "              <i class=\"material-icons left\">settings_applications</i> Configuracion\n"
            + "            </button>\n"
            + "          </div>\n"
            + "\n"
            + "        </div>\n"
            ...
            + "      <div class=\"panel_busqueda col l9 m8 s12\">\n"
            ...
            + "        </div>\n"
            + "      </div>\n"
            + "      <div class=\"panel_listaRep col l3 m4 s12\">\n"
            + "        <button id='act_listRep' class='btn col l12 m12 s12'><Strong>Actualiza Lista:</Strong></button>\n"
            + "        <ul>\n"
            + "          <li>Tema 1</li>\n"
            + "          <li>Tema 2</li>\n"
            + "          <li>Tema 3</li>\n"
